...
export function GlobeIcon({ size = 18, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      <Circle cx="12" cy="12" r="10" />
...
export function SmartphoneIcon({ size = 18, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      <Rect x="5" y="2" width="14" height="20" rx="2" ry="2" fill="none" />
      <Line x1="11" y1="18" x2="13" y2="18" />
    </Svg>
  );
}

export function FolderScanIcon({ size = 22, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
