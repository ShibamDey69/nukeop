...
export function GlobeIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      <Circle cx="12" cy="12" r="10" />
...
export function DeviceStorageIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
...
export function QueueIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      ...
      <Polygon points="17 9 17 19 22 16" fill={color} stroke="none" />
      <Line x1="17" y1="9" x2="17" y2="19" />
    </Svg>
  );
}

export function MusicNoteIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      <Path d="M9 18V5l12-2v13" />
      <Circle cx="6" cy="18" r="3" />
...
export function TrashIcon({ size = 18, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
...
export function FolderScanIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
...
export function RefreshIcon({ size = 18, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
...
export function DiscIcon({ size = 20, color = "#111111" }: IconProps) {
  return (
    <Svg {...base(size, color)}>
      <Circle cx="12" cy="12" r="10" />
      <Circle cx="12" cy="12" r="3" />
